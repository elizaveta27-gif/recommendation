...
#[AsCommand(
    name: 'app:view-write-top',
    description: 'Consume view events and write top products per category to Redis',
)]
class WriteTopCommand extends BaseCommand
{
    ...
    {
        return Config::TOP_CATEGORY_VIEW;
    }
